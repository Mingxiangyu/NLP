...
def run():
    ...
    for i in txt:
        print(i)
    summarize_text = TextRank_Word2vec.summarize(text, 3)
...
Button(myWindow, text='退出', command=myWindow.quit, font=('微软雅黑 12 bold')).grid(row=1, column=3, sticky=S, padx=20,
                                                                               pady=20)
